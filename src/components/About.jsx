        ...
        <div className='flex flex-col justify-center'>
           <p className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>About Me</p>
              <p>Grew up in Seattle, Washington, go to school in the bay area. 
                ...
                solar car. I was trying to program our car's brake light and embed that into our vehicle computer using Arduino. Coming form an electrical engineering background, I am fascinted by how computers and hardware interact.
